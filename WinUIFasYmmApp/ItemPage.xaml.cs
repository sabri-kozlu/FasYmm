...
using WinUIFasYmmApp.DesktopWap.Controls;
...
namespace WinUIFasYmmApp
{
    ...
    public sealed partial class ItemPage : Page
    {
        ...
        private static string GalleryBaseUrl = "https://github.com/microsoft/WinUI-Gallery/tree/main/WinUIFasYmmApp/ControlPages/";
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (item != null)
            {
                ...
                Type pageType = Type.GetType("WinUIFasYmmApp.ControlPages." + item.UniqueId + "Page");
